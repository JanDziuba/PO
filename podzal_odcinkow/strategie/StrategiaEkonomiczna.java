...
{	
	...
	public static void wykonajStrategieEkonomiczna(Dane dane)
	{
		Strategia strategia = new Strategia(dane);
		
		Strategia najlepszaStrategia = new Strategia(dane);
		
		najlepszaStrategia.lacznyKoszPretow = Long.MAX_VALUE;
			...
			long[] sumaDlugosciOdcinkowWPrecieTab)
	{
		...
		if (najlepszaStrategia.lacznyKoszPretow > strategia.lacznyKoszPretow)
		{
	...
	{
		int indeksPreta = 0;
		int indeksNajtanszegoOdpowiedniegoPreta;
		int cenaNajtanszegoOdpowiedniegoPreta;
		...
		else
		{
			...
			indeksNajtanszegoOdpowiedniegoPreta = indeksPreta;
			cenaNajtanszegoOdpowiedniegoPreta = dane.cenaPretaTab()[indeksNajtanszegoOdpowiedniegoPreta];
			
			for (; indeksPreta < dane.iloscPretow(); indeksPreta++)
			{
				if (cenaNajtanszegoOdpowiedniegoPreta > dane.cenaPretaTab()[indeksPreta])
				{
					indeksNajtanszegoOdpowiedniegoPreta = indeksPreta;
					cenaNajtanszegoOdpowiedniegoPreta = dane.cenaPretaTab()[indeksNajtanszegoOdpowiedniegoPreta];
				}
			...
			strategia.dlugoscNtegoKupionegoPretaTab[numerPreta] = dane.dlugoscPretaTab()[indeksNajtanszegoOdpowiedniegoPreta];
			odpad.dlugoscOdpadu((dane.dlugoscPretaTab()[indeksNajtanszegoOdpowiedniegoPreta] - (int)sumaDlugosciOdcinkowWPrecieTab[numerPreta]));
			pret.kosztPreta(dane.cenaPretaTab()[indeksNajtanszegoOdpowiedniegoPreta]);
